    ...
    <main className="min-h-screen bg-bg px-6 py-10 text-fg">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-4 text-sm leading-6 text-muted">
          ...
          fiscal nesta etapa. Documentos fiscais e logísticos devem respeitar as regras comerciais,
          fiscais e operacionais aplicáveis.
        </p>
        <p className="mt-4 text-sm leading-6 text-muted">
          O uso das integrações depende da autorização do usuário e das permissões concedidas pelos
