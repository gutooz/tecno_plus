...
const STATUS_STYLES: Record<string, { pill: string; dot: string }> = {
  ...
  awaiting_confirmation: { pill: 'bg-warning/15 text-warning', dot: 'bg-warning animate-pulse' },
  ...
  pending_review: { pill: 'bg-warning/15 text-warning', dot: 'bg-warning animate-pulse' },
...
const STATUS_LABEL: Record<string, string> = {
  ...
  error: 'Erro',
  pending: 'Pendente',
  awaiting_confirmation: 'Aguardando pagamento',
  approved: 'Aprovado',
  rejected: 'Rejeitado',
  posted: 'Publicado',
  active: 'Ativa',
  pending_review: 'Aguardando dados',
  paused: 'Pausada',
  completed: 'Concluída',
  archived: 'Arquivada',
  scheduled: 'Agendado',
